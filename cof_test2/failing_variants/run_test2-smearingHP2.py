...
params_dict = {
    'FORCE_EVAL': {
        'DFT': {
            ...
            'SCF': {
                'EPS_SCF': 1.0E-6,                                             #HP= STD
                'MAX_SCF': 2000,                                               #HP= STDx4
                'MAX_ITER_LUMO': 10000,
                'ADDED_MOS': 1000,
                'SMEAR': {
                    '_': 'ON',
    ...
    'MOTION': {
        'MD': {
            ...
            'STEPS': 100,                           #default: 3                 HP= STD
            'TIMESTEP': '[fs] 0.1',                 #default: [fs] 0.5          HP= STD/5
...
ids=['18081N2','18082N2'] #9Mar, again trying with smaller MD steps
