...
# subworkflows
from aiida_cp2k.workflows import Cp2kRobustCellOptWorkChain
...
class Cp2kCellOptDdecWorkChain(WorkChain):
    ...
    def run_geo_opt(self):
       ...
       # Expand the unit cell so that: min(perpendicular_width) > threshold
        ...
        running = submit(Cp2kRobustCellOptWorkChain, **inputs)
        self.report("pk: {} | Running Cp2kRobustCellOptWorkChain to optimize geometry".format(running.pid))
    ...
    def return_results(self):
        ...
        self.report("Cp2kCellOptDdecWorkChain is completed.")
